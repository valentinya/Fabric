...
var InterfaceParserHelper = (function (_super) {
    ...
    function InterfaceParserHelper(str) {
        ...
        _this._state = ParseState.default;
        return _this;
    }
                ...
                case ParseState.declaration:
                    {
                        ...
                        var propType = isDeprecated ? interfaces_1.InterfacePropertyType.deprecated : (isOptional ? interfaces_1.InterfacePropertyType.optional : interfaces_1.InterfacePropertyType.required);
                        this._state = ParseState.default;
                        returnResult.push({
                            description: comment,
                            name: identifierName,
