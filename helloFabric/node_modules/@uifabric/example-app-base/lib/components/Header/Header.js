...
var withResponsiveMode_1 = require("office-ui-fabric-react/lib/utilities/decorators/withResponsiveMode");
require("./Header.scss");
var Header = (function (_super) {
    __extends(Header, _super);
    function Header(props) {
        var _this = _super.call(this, props) || this;
        _this._onGearClick = _this._onGearClick.bind(_this);
        _this._onDismiss = _this._onDismiss.bind(_this);
        _this._onRTLToggled = _this._onRTLToggled.bind(_this);
        _this._onMenuClick = _this._onMenuClick.bind(_this);
        _this.state = {
            contextMenu: null,
            isRTLEnabled: Utilities_1.getRTL()
        };
        return _this;
    }
    Header.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            contextMenu ? (React.createElement(ContextualMenu_1.ContextualMenu, { items: contextMenu.items, isBeakVisible: true, targetElement: contextMenu.target, directionalHint: ContextualMenu_1.DirectionalHint.bottomAutoEdge, gapSpace: 5, onDismiss: this._onDismiss })) : (null)));
    };
    ...
    Header.prototype._onRTLToggled = function (ev) {
        ...
        Utilities_1.setRTL(!isRTLEnabled);
        this.setState({
